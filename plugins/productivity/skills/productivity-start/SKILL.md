...
**If `dashboard.html` doesn't exist:** Copy the `dashboard.html` bundled alongside this skill into the current working directory.
...
Tell the user: "Dashboard is ready at `dashboard.html`. Open it in your browser to get started."
